...
export const TRANSLATIONS_PART_1: Record<string, TranslationBlockItem> = {
  ...
  "q-oeff-1": {
    ...
    loesung: {
      ...
      en: "Protection of the inviolability of the legal order, protection of individual legal assets, and the protection of state institutions and facilities."
    }
  },
  ...
  "q-oeff-2": {
    ...
    loesung: {
      ...
      en: "The totality of unwritten rules for behavior in public spaces which, according to prevailing societal views, are considered an indispensable prerequisite for orderly coexistence."
    }
  },
  ...
  "q-oeff-3": {
    ...
    loesung: {
      ...
      en: "The private security officer has no sovereign powers. They possess the exact same rights as any regular citizen (citizen's rights / Jedermannsrechte) plus the rights delegated to them by the client/property owner. In contrast, the police possess sovereign statutory powers."
    }
  },
  ...
  "q-oeff-4": {
    ...
    loesung: {
      ...
      en: "Rights and authority exclusively granted to the state and its authorities for the enforcement of law and legal order."
    }
  },
  ...
  "q-oeff-5": {
    ...
    loesung: {
      ...
      en: "It governs that, fundamentally, only the state is entitled to use physical force and coercion to enforce laws and rights. The only exceptions for private individuals are statutory emergency rights."
    }
  },
  ...
  "q-oeff-6": {
    frage: {
      fa: "منظور از «فرعی بودن / اصل تابعیت» خدمات امنیتی خصوصی چیست؟",
      ar: "ماذا يعني مبدأ «التبعية والصفة الثانوية» لخدمات الأمن الخاصة؟",
    ...
    loesung: {
      ...
      en: "Private security services operate subordinate to the state. They do not replace the police force, but rather provide preventative support under private contracts."
    }
  },
  ...
  "q-oeff-7": {
    ...
    loesung: {
      ...
      en: "When a situation arises in which there is a sufficient likelihood of harm threatening a legally protected interest."
    }
  },
  ...
  "q-oeff-8": {
    frage: {
      fa: "آیا یک نیروی امنیتی مجاز است در فضای عمومی دستور اخراج یا منع تردد صادر کند؟",
      ar: "هل يحق لموظف الأمن إصدار أمر إخلاء أو حظر تواجد لأي شخص في الأماكن العامة؟",
      ru: "Имеет ли право сотрудник службы безопасности выдавать распоряжение покинуть общественное место?",
      en: "Is a security guard allowed to issue a ban from the premises/area in a public space?"
    },
    loesung: {
      fa: "خیر، صدور دستور اخراج از فضای عمومی منحصراً در صلاحیت مأموران پلیس یا اداره نظم عمومی است. با این حال، در ملک محصور و خصوصی، نیروی امنیتی می‌تواند به استناد حق مقررات مکانی تفویض‌شده از سوی مالک افراد را اخراج نماید.",
      ar: "لا، إن إصدار أوامر الإبعاد والإخلاء من الأماكن العامة مقتصر حصراً على سلطة الشرطة أو مكتب النظام العام. ومع ذلك، في العقارات والأماكن الخاصة المحمية، يحق لموظف الأمن طرد الأشخاص ومنعهم بموجب حق إدارة المكان المفوض له.",
      ru: "Нет, выдавать предписание покинуть общественное место имеет право только полиция или ведомство правопорядка. Однако на огороженной частной территории сотрудник охраны может выдворить нарушителя на основании делегированного права распоряжения объектом.",
      en: "No, issuing a dispersal order/area ban in public spaces is strictly reserved for the police or the public order office. However, on enclosed private property, the security officer may do so based on delegated domiciliary rights."
    }
  },
  ...
  "q-oeff-9": {
    frage: {
      fa: "منظور از «حق یا مصلحت تحت حفاظت قانونی» چیست؟",
      ar: "ما هو «المصلحة أو الحق المحمي قانوناً»؟",
      ru: "Что такое «Правовое благо»?",
      en: "What is a 'legally protected interest / Legal asset'?"
    },
    loesung: {
      ...
      en: "An interest, value, or asset protected by law, belonging either to an individual or to the community as a whole."
    }
  },
  ...
  "q-oeff-10": {
    ...
    loesung: {
      ...
      en: "The police immediately assume full command and operational authority at the scene. The security guard acts as a witness and must strictly follow the instructions of the police."
    }
  },
  ...
  "q-oeff-11": {
    frage: {
      fa: "تفاوت بین «حقوق ماهوی» و «حقوق شکلی» چیست؟",
      ar: "ما هو الفرق بين «القانون الموضوعي» و«القانون الإجرائي / الشكلي»؟",
    ...
    loesung: {
      ...
      en: "Substantive law defines rights, duties, offenses, and penalties (the 'what', e.g., Criminal Code StGB, Civil Code BGB). Procedural law governs the enforcement processes and legal proceedings (the 'how', e.g., Code of Criminal Procedure StPO)."
    }
  },
  ...
  "q-oeff-13": {
    frage: {
      fa: "آیا قانون آیین دادرسی کیفری برای نیروهای امنیتی خصوصی نیز اعمال می‌شود؟",
      ar: "هل ينطبق قانون الإجراءات الجنائية على حراس الأمن الخاص؟",
      ru: "Распространяется ли Уголовно-процессуальный кодекс на сотрудников частной охраны?",
      en: "Does the Code of Criminal Procedure apply to private security personnel?"
    },
    loesung: {
      ...
      en: "Yes, specifically regarding citizen's rights (such as provisional arrest under § 127 StPO); otherwise, it primarily governs the work of the public prosecutor's office and the police."
    }
  },
  ...
  "q-oeff-14": {
    ...
    loesung: {
      ...
      en: "Private law governs legal relationships between legally equal parties. Public law governs the hierarchical relationship of authority and subordination between the state and citizens."
    }
  },
  ...
  "q-oeff-15": {
    ...
    loesung: {
      fa: "زیرا در ملک خصوصی، حق مقررات مکانی مالک حاکم است که می‌تواند به نیروی امنیتی تفویض شود (اختیار تفتیش داوطلبانه، ممانعت از ورود و اخراج)، در حالی که در فضای عمومی تنها اختیارات همگانی شهروندی معتبر است.",
      ar: "لأنه في الأماكن والعقارات الخاصة يسري حق إدارة المكان الممنوح للمالك والذي يمكن تفويضه لحارس الأمن، في حين لا تسري في الأماكن العامة سوى حقوق الكافة المتاحة لأي مواطن عادي.",
      ru: "Потому что на частной территории действует право распоряжения владельца, которое может быть делегировано охраннику, тогда как в общественных местах действуют исключительно общегражданские права каждого.",
      en: "Because on private property, the owner's domiciliary rights apply, which can be delegated to the security officer, whereas in public spaces only citizen's rights are available."
    }
  },
  ...
  "q-gew-1": {
    frage: {
      fa: "کدام بند و ماده از قانون اصناف و تجارت آلمان پایه و اساس قانونی حرفه شماست؟",
      ar: "أي مادة من قانون تنظيم المهن والتجارة الألماني تعتبر الأساس القانوني لمهنتك؟",
      ru: "Какая статья Закона о регулировании промыслов является правовой основой вашей профессии?",
      en: "Which paragraph of the German Trade Regulation Act forms the legal foundation of your profession?"
    },
    loesung: {
      ...
      en: "Section 34a of the Trade Regulation Act."
    }
  },
  ...
  "q-gew-2": {
    frage: {
      fa: "تفاوت بین «دوره آموزشی مقدماتی» و «آزمون تخصصی مهارت» چیست؟",
      ar: "ما هو الفرق بين «الدورة الإرشادية والتثقيفية» و«امتحان الكفاءة والخبرة المهنية»؟",
      ru: "В чем разница между «процедурой инструктажа» и «экзаменом на компетентность»?",
      en: "What is the difference between the instruction procedure and the expertise examination?"
    },
    loesung: {
      fa: "دوره آموزشی مقدماتی صرفاً شامل حضور در کلاس‌های آموزشی بدون آزمون است (برای وظایف ساده نظیر گشت کارگاهی کافی است). آزمون تخصصی مهارت نیازمند قبولی در آزمون کتبی و شفاهی اتاق بازرگانی IHK است (برای مشاغل پرخطر مانند دربانی کلاب‌ها، کارآگاهان فروشگاهی و سرپرستی کمپ‌های پناهجویان اجباری است).",
      ...
      ru: "Инструктаж предполагает лишь прослушивание курса без сдачи экзамена (достаточно для простых задач, например постовой службы). Экзамен на компетентность требует успешной сдачи письменной и устной частей в IHK (обязателен для охранников клубов, детективов в магазинах, руководства охраной центров для беженцев).",
      en: "The instruction procedure involves mandatory attendance of a course without an examination. The expertise examination requires passing both a written and oral exam at the IHK."
    }
  },
  ...
  "q-gew-3": {
    frage: {
      fa: "برای کدام فعالیت‌های حراستی و نگهبانی قبولی در آزمون تخصصی مهارت الزامی و اجباری است؟",
      ar: "ما هي أنشطة ومهام الحراسة التي يشترط فيها وجوباً الحصول على شهادة امتحان الكفاءة؟",
      ru: "Для каких видов охранной деятельности обязательно требуется сдача экзамена на компетентность?",
      en: "For which security activities is passing the expertise examination strictly mandatory?"
    },
    loesung: {
  ...
  "q-gew-4": {
    frage: {
      fa: "سامانه سراسری ثبت نگهبانان چیست؟",
      ar: "ما هو السجل الفيدرالي لبيانات حراس الأمن؟",
      ru: "Что представляет собой Федеральный реестр охранников?",
      en: "What is the Federal Security Guard Register?"
    },
    loesung: {
  ...
  "q-gew-5": {
    ...
    loesung: {
      fa: "تنها پس از ثبت رسمی و تأیید و صدور مجوز نهایی (تغییر وضعیت به حالت «فعال / aktiv») توسط اداره ذی‌صلاح دولتی در سامانه ثبت نگهبانان.",
  ...
  "q-gew-6": {
    frage: {
      fa: "کارت شناسایی خدمت یک نیروی نگهبان باید حاوی چه مشخصاتی باشد؟",
      ar: "ما هي البيانات والمعلومات التي يجب أن تتضمنها بطاقة الهوية المهنية لحارس الأمن؟",
    ...
    loesung: {
      fa: "نام و نام خانوادگی نگهبان، نام و نشانی شرکت امنیتی کارفرما، عکس پرسنلی نگهبان، امضای کارفرما (یا نماینده مجاز او) و شماره شناسایی اختصاصی فرد در سامانه ثبت نگهبانان.",
      ...
      en: "First and last name of the guard, name and address of the security firm, photo of the guard, signature of the employer, and the unique ID number from the Security Guard Register."
    }
  },
  ...
  "q-gew-7": {
    ...
    loesung: {
      ...
      en: "Security guards performing tasks for which the expertise examination is mandatory must wear a clearly visible badge showing their name or ID number and the security company name."
    }
  },
  ...
  "q-gew-8": {
    ...
    loesung: {
      fa: "یک بیمه مسئولیت مدنی شغلی با حداقل پوشش‌های مالی تعیین‌شده در قانون برای خسارات جانی، مالی، ضررهای اقتصادی و همچنین مفقود شدن یا به سرقت رفتن اشیاء تحت حفاظت.",
  ...
  "q-gew-9": {
    frage: {
      fa: "منظور از «ممنوعیت به‌کارگیری» در حقوق اصناف و تجارت چیست؟",
      ar: "ماذا يُقصد بمفهوم «حظر التوظيف والتشغيل» في قانون المهن؟",
      ru: "Что понимается под «запретом на работу / наем» в промысловом праве?",
    ...
    loesung: {
      ...
      en: "The employer is strictly prohibited from employing individuals who are not cleared in the Guard Register, lack personal reliability/background clearance, or cannot prove required qualifications."
    }
  },
  ...
  "q-gew-10": {
    ...
    loesung: {
      fa: "او موظف است لغو ثبت صنف را رسماً اعلام کرده و فوراً تمامی پرسنل را در سامانه ثبت نگهبانان غیرفعال و از فهرست خارج نماید.",
      ar: "يجب عليه تقديم إخطار رسمي بإلغاء النشاط التجاري وشطب الموظفين والعمال فوراً من السجل الفيدرالي للحراس.",
      ru: "Он обязан подать заявление о снятии с учета предприятия и незамедлительно снять весь персонал с учета в реестре охранников.",
  ...
  "q-gew-11": {
    frage: {
      fa: "کدام نهاد دولتی بر رعایت ضوابط ماده 34a قانون اصناف نظارت می‌کند؟",
      ...
      en: "Which authority monitors compliance with Section 34a of the Trade Regulation Act?"
    },
    loesung: {
      fa: "اداره امور نظم عمومی، بخشداری/فرمانداری یا در برخی ایالت‌ها پلیس آگاهی و همچنین اتاق بازرگانی و صنایع در رابطه با نظارت بر آزمون‌ها.",
      ar: "مكتب النظام العام المختص، إدارة المقاطعة، أو الشرطة الجنائية في بعض الولايات، ولجنة الاختبارات لدى غرفة الصناعة والتجارة فيما يتعلق بالامتحانات.",
      ru: "Компетентное ведомство правопорядка, районное управление или в некоторых землях уголовная полиция, а также экзаменационная комиссия IHK в части экзаменов.",
      en: "The competent Public Order Office, District Administration Office, or criminal police in some federal states, and the IHK examination board regarding exams."
    }
  },
  ...
  "q-gew-12": {
    frage: {
      fa: "ماده ۴ آیین‌نامه نگهبانی و حراست چه مواردی را تعیین می‌کند؟",
      ar: "ما الذي تنظمه المادة § 4 من اللائحة التنفيذية للحراسة؟",
      ru: "Что регулирует параграф 4 Положения об охранной деятельности?",
      en: "What is governed by Section 4 of the Guarding Ordinance?"
    },
    loesung: {
      fa: "الزامات و تکالیف مربوط به صدور، همراه داشتن و ارائه کارت شناسایی خدمت توسط نگهبان.",
  ...
  "q-gew-13": {
    ...
    loesung: {
      ...
      en: "No. The work uniform must not lead to confusion with state authorities. Badges, patches, and uniform items must differ distinctly."
    }
  },
