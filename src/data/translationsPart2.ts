...
export const TRANSLATIONS_PART_2: Record<string, TranslationBlockItem> = {
  ...
  "q-bgb-1": {
    frage: {
      fa: "تفاوت میان «مالکیت» و «تصرف» را با ذکر یک مثال ملموس توضیح دهید.",
      ar: "اشرح الفرق بين «الملكية» و«الحيازة» من خلال مثال عملي ملموس.",
      ru: "Объясните разницу между «собственностью» и «владением» на конкретном примере.",
      en: "Explain the difference between ownership and possession using a concrete example."
    },
    loesung: {
      ...
      en: "The security company purchases a two-way radio. During duty, the security guard uses the radio."
    }
  },
  ...
  "q-bgb-2": {
    frage: {
      fa: "منظور قانون مدنی آلمان از «زورگویی و تصرف غیرقانونی / خودسری ممنوعه» چیست؟",
      ar: "ماذا يقصد القانون المدني بمفهوم «الافتئات غير المشروع على الحيازة / التصرف التعسفي المحظور»؟",
      ru: "Что понимает Гражданский кодекс под «самоуправным нарушением владения»?",
      en: "What does the German Civil Code understand by 'unlawful interference with possession'?"
    },
    loesung: {
  ...
  "q-bgb-3": {
    frage: {
      fa: "چه زمانی می‌توان از «دفاع از تصرف» استفاده کرد؟",
      ar: "متى يحق قانوناً استخدام «الدفاع عن الحيازة»؟",
      ru: "Когда разрешено применять «защиту владения от посягательства (Besitzwehr - § 859 ч. 1 BGB)»?",
      en: "When is one permitted to exercise 'defense of possession (Besitzwehr - § 859 BGB)'?"
    },
    loesung: {
      ...
      en: "Immediately, in order to resist an ongoing unlawful interference with possession using proportionate force."
    }
  },
  ...
  "q-bgb-4": {
    frage: {
      fa: "چه زمانی می‌توان از «بازپس‌گیری تصرف» استفاده کرد؟",
      ar: "متى يحق قانوناً ممارسة «استرداد الحيازة بالقوة»؟",
      ru: "Когда разрешено применять «возврат владения по горячим следам (Besitzkehr - § 859 ч. 2 BGB)»?",
      en: "When is one permitted to exercise 'recovery of possession (Besitzkehr - § 859 BGB)'?"
    },
    loesung: {
  ...
  "q-bgb-5": {
    frage: {
      fa: "حق مقررات مکانی و حریم اماکن چه مواردی را تعیین می‌کند و پایه آن در قانون مدنی چیست؟",
      ar: "ما الذي ينظمه حق إدارة المكان وحرمة المنشأة وعلى ماذا يستند في القانون المدني؟",
      ru: "Что регулирует право распоряжения объектом и на чем оно основано в Гражданском кодексе?",
      en: "What does domiciliary rights govern and on what is it based in the German Civil Code?"
    },
    loesung: {
      fa: "بر پایه حق مالکیت و حق تصرف استوار است و به صاحب حق اجازه می‌دهد تعیین کند چه کسانی مجاز به ورود به ملک/ساختمان هستند و چه کسانی باید فوراً آنجا را ترک کنند.",
      ar: "يستند إلى حق الملكية وحق الحيازة، ويمنح صاحب الحق الصلاحية الكاملة لتحديد من يُسمح له بدخول العقار/المبنى ومن يجب عليه مغادرته فوراً.",
      ru: "Оно основано на праве собственности и праве владения и позволяет правообладателю определять, кто имеет право входить на территорию/в здание, а кто обязан покинуть объект.",
      en: "It is based on ownership and possession rights, allowing the holder to determine who may enter the premises/building and who must leave."
    }
  },
  ...
  "q-bgb-6": {
    frage: {
      fa: "«اضطرار تدافعی» چیست؟",
      ar: "ما هي «حالة الضرورة الدفاعية»؟",
      ru: "Что такое «Оборонительная крайняя необходимость»?",
      en: "What is 'defensive state of necessity'?"
    },
    loesung: {
      ...
      en: "Damaging or destroying someone else's property to avert a danger originating from that property itself. The damage must not be disproportionate to the danger."
    }
  },
  ...
  "q-bgb-7": {
    frage: {
      fa: "«اضطرار تهاجمی» چیست؟",
      ar: "ما هي «حالة الضرورة الهجومية»؟",
      ru: "Что такое «Агрессивная крайняя необходимость»?",
      en: "What is 'aggressive state of necessity'?"
    },
    loesung: {
  ...
  "q-bgb-8": {
    frage: {
      fa: "ماده «احقاق حق شخصی عمومی» چه می‌گوید؟",
      ar: "ماذا تنص المادة الخاصة بـ «المساعدة الذاتية العامة»؟",
      ru: "Что гласит положение об «Общей самопомощи согласно § 229 BGB»?",
      en: "What does General Self-Help under Section 229 of the German Civil Code state?"
    },
    loesung: {
  ...
  "q-bgb-9": {
    frage: {
      fa: "شروط و پیش‌نیازهای قانونی اجرای احقاق حق شخصی را نام ببرید.",
      ar: "اذكر الشروط والمتطلبات القانونية لممارسة المساعدة الذاتية العامة.",
      ru: "Назовите условия и предпосылки для применения общей самопомощи.",
      en: "Name the prerequisites for exercising General Self-Help."
    },
    loesung: {
      ...
      en: "Existence of a valid civil law claim, official assistance cannot be obtained in time, suspicion of flight by the debtor, and the danger that enforcement of the claim would otherwise be thwarted."
    }
  },
  ...
  "q-bgb-10": {
    frage: {
      fa: "تفاوت میان دفاع مشروع در قانون مدنی و قانون مجازات چیست؟",
      ar: "ما هو الفرق بين الدفاع الشرعي في القانون المدني وقانون العقوبات؟",
      ru: "В чем разница между необходимой обороной в Гражданском кодексе и в Уголовном кодексе?",
      en: "What is the difference between self-defense in civil law and in criminal law?"
    },
    loesung: {
      ...
      en: "In terms of content, they are identical. Section 227 BGB excludes civil liability for damages; Section 32 StGB excludes criminal liability and punishment."
    }
  },
  ...
  "q-bgb-11": {
    frage: {
      fa: "ممنوعیت سوءاستفاده از حق و ایذا به چه معناست؟",
      ar: "ماذا يعني مبدأ «حظر التعسف في استعمال الحق والكيد»؟",
      ru: "Что означает «Запрет на злоупотребление правом / шикану»?",
      en: "What is meant by the 'prohibition of malicious exercise of rights / ban on chicanery'?"
    },
    loesung: {
      ...
      en: "The exercise of a right is inadmissible if its sole intended purpose can only be to inflict damage or harassment upon another person."
    }
  },
  ...
  "q-bgb-12": {
    frage: {
      fa: "مسئولیت مدنی و جبران خسارت از چه سنی آغاز می‌شود؟",
      ar: "من أي سن تبدأ الأهلية القانونية للمسؤولية عن الأضرار والتعويض؟",
      ru: "С какого возраста наступает деликтоспособность (ответственность за причинение вреда)?",
      en: "From what age is a person liable for damages?"
    },
    loesung: {
      fa: "مسئولیت مشروط از ۷ سالگی (در حوادث ترافیک جاده‌ای از ۱۰ سالگی)، و مسئولیت کامل مدنی از سن ۱۸ سالگی تمام.",
      ar: "مسؤولية مشروطة ومقيدة تبدأ من سن 7 سنوات (وفي حوادث السير والمرور من سن 10 سنوات)، وتبدأ الأهلية الكاملة للمسؤولية عن التعويض عند بلوغ سن 18 عاماً.",
      ru: "Частичная с 7 лет (в дорожно-транспортных происшествиях с 10 лет), полная деликтоспособность наступает с 18 лет.",
      en: "Conditional liability starts from age 7; full tort capacity starts at age 18."
    }
  },
  ...
  "q-bgb-13": {
    frage: {
      fa: "شخص حقوقی چیست؟",
      ar: "ما هو «الشخص الاعتباري / القانوني»؟",
    ...
    loesung: {
      ...
      en: "An association of persons or an estate of assets recognized by law as having legal capacity."
    }
  },
  ...
  "q-bgb-14": {
    frage: {
      fa: "بر اساس قانون مدنی آلمان مفهوم «مال / شیء» به چه معناست؟",
      ar: "ما هو مفهوم «الشيء» وفقاً للقانون المدني؟",
      ru: "Что понимается под «вещью» в смысле Гражданского кодекса?",
      en: "What is understood by an 'item / thing' under the German Civil Code?"
    },
    loesung: {
      fa: "طبق ماده ۹۰ قانون مدنی، اشیاء تنها اجسام و اشیای مادی و فیزیکی هستند. (حیوانات شیء نیستند، اما از نظر حقوقی عمدتاً مقررات اشیاء بر آن‌ها اعمال می‌شود، § 90a BGB).",
      ...
      en: "According to Section 90 BGB, things are only tangible physical objects.."
    }
  },
  ...
  "q-bgb-15": {
    ...
    loesung: {
      fa: "حق احقاق حق شخصی عمومی جهت تضمین ادعای استرداد کالا به همراه حق بازداشت موقت شهروندی طبق ماده ۱۲۷ بند ۱ آیین دادرسی کیفری.",
      ar: "حق المساعدة الذاتية العامة لتأمين الحق في استرداد البضاعة والمسروقات، بالإضافة إلى حق التوقيف المؤقت المتاح للكافة وفق المادة § 127 الفقرة 1 من قانون الإجراءات الجنائية StPO.",
      ru: "Общей самопомощью для обеспечения требования о возврате похищенного товара, а также правом каждого на временное задержание по § 127 ч. 1 УПК StPO.",
      en: "General Self-Help to secure the claim for return of the goods, alongside the right to provisional citizen's arrest under Section 127 of the Code of Criminal Procedure."
    }
  },
  ...
  "q-st-1": {
    frage: {
      fa: "تعریف حقوقی «دفاع مشروع» چیست؟",
      ar: "ما هو التعريف القانوني لـ «الدفاع الشرعي»؟",
      ru: "Каково определение «необходимой обороны»?",
      en: "What is the legal definition of self-defense?"
    },
    loesung: {
      ...
      en: "Self-defense is the defense necessary to avert a present, unlawful attack upon oneself or another person."
    }
  },
  ...
  "q-st-2": {
    frage: {
      fa: "یک حمله چه زمانی «جاری و حاضر» محسوب می‌شود؟",
      ar: "متى يعتبر الاعتداء «حالاً ووشيكاً»؟",
      ru: "Когда нападение признается «наличным»?",
  ...
  "q-st-3": {
    frage: {
      fa: "یک حمله چه زمانی «غیرقانونی و نامشروع» است؟",
      ar: "متى يعتبر الاعتداء «غير مشروع ومخالفاً للقانون»؟",
      ru: "Когда нападение признается «противоправным»?",
    ...
    loesung: {
      ...
      en: "When the attacker has no legal right or justification to commit the attack."
    }
  },
  ...
  "q-st-4": {
    frage: {
      fa: "منظور از حق بازداشت موقت همگانی چیست؟",
      ...
      en: "What is understood by the right to provisional citizen's arrest (§ 127 StPO)?"
    },
    loesung: {
  ...
  "q-st-5": {
    frage: {
      fa: "اصطلاح «در حین ارتکاب جرم دستگیر شدن» به چه معناست؟",
      ar: "ماذا يعني التعبير القانوني «ضُبط متلبساً بالجرم المشهود»؟",
      ru: "Что означает понятие «застигнут на месте преступления с поличным»?",
      en: "What does 'caught in the act' mean?"
    },
    loesung: {
  ...
  "q-st-6": {
    frage: {
      ...
      en: "Is a security guard permitted to search a person detained under Section 127 StPO?"
    },
    loesung: {
      ...
      en: "Fundamentally no, that is the task of the police. Exception: Solely for self-protection if concrete suspicion exists."
    }
  },
  ...
  "q-st-7": {
    frage: {
      fa: "تفاوت میان «عامل موجهه جرم / دلیل مشروعیت» و «عامل رافع مسئولیت کیفری / عذر معاف‌کننده» چیست؟",
      ar: "ما هو الفرق بين «سبب الإباحة والتبرير» و«عذر الإعفاء من المسؤولية والعقاب»؟",
      ru: "В чем разница между «основанием оправдания» и «основанием извинения / освобождения от вины»?",
      en: "What is the difference between a justification and an excuse?"
    },
    loesung: {
      ...
      en: "A justification renders the act lawful. An excuse leaves the act unlawful, but the actor acts without culpability and is not punished."
    }
  },
  ...
  "q-st-8": {
    frage: {
      fa: "«اضطرار موجهه / توجیه‌کننده» چیست؟",
      ar: "ما هي «حالة الضرورة المبررة والمبيحة»؟",
      ru: "Что такое «Оправдывающая крайняя необходимость»?",
      en: "What is 'justifying state of necessity'?"
    },
    loesung: {
  ...
  "q-st-9": {
    frage: {
      fa: "«ایراد ضرب و جرح در حین انجام وظیفه رسمی» چیست؟ آیا نیروی امنیتی خصوصی می‌تواند مرتکب آن شود؟",
      ar: "ما هي جريمة «الإيذاء الجسدي أثناء ممارسة الوظيفة العامة»؟ وهل يمكن لحارس الأمن الخاص ارتكابها؟",
      ru: "Что такое «Причинение телесных повреждений при исполнении служебных обязанностей»? Может ли охранник совершить это преступление?",
      en: "What is 'bodily injury in office / by a public official'? Can a private security guard commit this offense?"
    },
    loesung: {
      fa: "خیر. این جرم ویژه تنها توسط مأموران و مقامات رسمی دولتی (مانند مأموران پلیس) قابل ارتکاب است. نیروی امنیتی خصوصی در صورت ضرب و جرح بر اساس مواد عمومی ایراد ضرب و جرح ساده یا خطرناک مجازات می‌شود.",
      ar: "لا. هذه الجريمة خاصة ولا يمكن أن يرتكبها إلا الموظفون الرسميون وأصحاب السلطة العامة (كالشرطة). أما حارس الأمن الخاص فيُعاقب في حال اعتدائه بتهمة الإيذاء البدني البسيط أو الخطير وفق المواد العامة.",
      ru: "Нет. Это преступление может быть совершено только должностными лицами (например, полицейскими). Сотрудник службы безопасности наказывается за обычное или опасное причинение вреда здоровью.",
      en: "No. This offense can only be committed by public officials. A private security guard is punished under general provisions for simple or dangerous bodily injury."
    }
  },
  ...
  "q-st-10": {
    frage: {
      fa: "تفاوت میان «سرقت ساده» و «سرقت توأم با زور / راهزنی» چیست؟",
      ar: "ما هو الفرق بين «السرقة العادية» و«السرقة بالإكراه والسطو»؟",
      ru: "В чем различие между «кражей» и «грабежом / разбоем»?",
      en: "What distinguishes theft from robbery?"
    },
    loesung: {
      fa: "سرقت، ربودن مال منقول متعلق به دیگری به قصد تملک است. سرقت توأم با زور، انجام سرقت با به‌کارگیری خشونت و زور فیزیکی علیه شخص یا تهدید با خطر جانی یا بدنی فوری است.",
      ar: "السرقة هي اختلاس وانتزاع مال منقول مملوك للغير بنية التملك. أما السطو والسرقة بالإكراه فهو سرقة تقترن باستخدام العنف الجسدي ضد شخص أو التهديد بخطر حالٍ يهدد الحياة أو السلامة الجسدية.",
  ...
  "q-st-11": {
    frage: {
      fa: "«ورود غیرمجاز به حریم خصوصی و ملک محصور» چیست؟",
      ar: "ما هي جريمة «انتهاك حرمة المساكن والعقارات المحمية»؟",
      ru: "Что такое «Нарушение неприкосновенности жилища / владения»?",
      en: "What constitutes 'trespassing / breach of the domestic peace'?"
    },
    loesung: {
  ...
  "q-st-12": {
    frage: {
      fa: "«تخریب اموال» چه زمانی مستوجب مجازات است؟",
      ar: "متى تكون جريمة «إتلاف الممتلكات» معاقباً عليها قانوناً؟",
      ru: "Когда наказуемо «повреждение чужого имущества»?",
      en: "When is 'property damage' punishable?"
    },
    loesung: {
      ...
      en: "Whoever unlawfully damages or destroys property belonging to another. Unauthorized alteration of the appearance is also included. The attempt is punishable."
    }
  },
  ...
  "q-st-13": {
    frage: {
      fa: "منظور از «خودداری از کمک‌رسانی» چیست؟",
      ar: "ما المقصود بجريمة «الامتناع عن تقديم المساعدة والإغاثة»؟",
      ru: "Что понимается под «неоказанием помощи»?",
      en: "What is understood by 'failure to render assistance'?"
    },
    loesung: {
      ...
      en: "Failing to provide assistance in accidents, common danger, or emergencies, even though it was necessary and reasonably expected under the circumstances."
    }
  },
  ...
  "q-st-14": {
    frage: {
      fa: "«جرم مقید به شکایت شاکی خصوصی» چیست؟ یک مثال بزنید.",
      ar: "ما هي «الجرائم التي تتطلب شكوى شخصية من المتضرر»؟ اذكر مثالاً.",
      ru: "Что такое «преступление, преследуемое по жалобе потерпевшего»? Приведите пример.",
      en: "What is an 'offense prosecuted only upon request'? Give an example."
    },
    loesung: {
      ...
      en: "An offense that is generally prosecuted only if the victim files a formal criminal complaint."
    }
  },
  ...
  "q-st-15": {
    frage: {
      fa: "تفاوت میان «شراکت در جرم» و «معاونت در جرم» چیست؟",
      ar: "ما هو الفرق بين «المشاركة الأصلية في الجريمة» و«المعاونة والمساعدة»؟",
      ru: "В чем разница между «соисполнительством» и «пособничеством»?",
      en: "What is the difference between co-perpetration and aiding and abetting?"
    },
    loesung: {
      fa: "شرکای جرم جرم را با همکاری و به صورت مشترک به اجرا درمی‌آورند. در حالی که معاون جرم صرفاً با پشتیبانی و تسهیل آگاهانه جرم اصلی دیگری، کمک می‌رساند (مانند دیده‌بانی دادن و زاغ‌سیاه چوب زدن).",
      ar: "الشركاء الأصليون (§ 25 الفقرة 2 StGB) ينفذون الجريمة معاً وبشكل مشترك. بينما المعاون أو المساعد يقدم مجرد الدعم والتسهيل الواعي للجريمة الرئيسية التي يرتكبها شخص آخر (مثل مراقبة الطريق).",
      ru: "Соисполнители (§ 25 ч. 2 StGB) совершают преступление совместно. Пособник лишь оказывает содействие, осознанно помогая совершению чужого основного преступления (например, стоит на страже).",
      en: "Co-perpetrators (§ 25 StGB) execute the offense jointly. An accessory / aider merely provides assistance by deliberately supporting another person's main crime."
    }
  }
};
