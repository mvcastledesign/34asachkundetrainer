...
export const STREAK_QUESTIONS: StreakQuestion[] = [
  {
    "id": "streak_1",
    ...
    "translations": {
      "en": {
        "question": "What powers do private security personnel possess in public spaces?"
      },
      "ru": {
        "question": "Какими правами обладают частные охранники в общественных местах?"
      },
      "ar": {
        "question": "ما هي الصلاحيات التي يمتلكها حراس الأمن في الأماكن العامة؟"
      },
      "fa": {
        "question": "نیروهای امنیتی خصوصی در اماکن عمومی چه اختیاراتی دارند؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "For which activity is the § 34a expertise examination mandatory?"
      },
      "ru": {
        "question": "Для какой деятельности обязателен экзамен на компетентность § 34a?"
      },
      "ar": {
        "question": "لأي نشاط يُشترط اجتياز امتحان الكفاءة § 34a إجبارياً؟"
      },
      "fa": {
        "question": "برای کدام فعالیت، آزمون تخصصی مهارت § 34a اجباری است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Which identification document must security personnel always carry while on duty?"
      },
      "ru": {
        "question": "Какой документ охранник обязан всегда иметь при себе во время службы?"
      },
      "ar": {
        "question": "ما هي الوثيقة التي يجب على حارس الأمن حملها دائماً أثناء الخدمة؟"
      },
      "fa": {
        "question": "نگهبان همواره چه مدرکی را باید در حین خدمت به همراه داشته باشد؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Is a security service allowed to store personal data indefinitely?"
      },
      "ru": {
        "question": "Имеет ли право служба охраны хранить персональные данные бессрочно?"
      },
      "ar": {
        "question": "هل يجوز لشركة الحراسة تخزين البيانات الشخصية لأجل غير مسمى؟"
      },
      "fa": {
        "question": "آیا شرکت امنیتی مجاز است داده‌های شخصی را نامحدود ذخیره کند؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "What must strictly be present for video surveillance in publicly accessible spaces?"
      },
      "ru": {
        "question": "Что обязательно требуется при видеонаблюдении в общественных местах?"
      },
      "ar": {
        "question": "ما هو الشرط الإلزامي للمراقبة بالكاميرات في الأماكن العامة؟"
      },
      "fa": {
        "question": "در دوربین‌های مداربسته در اماکن عمومی چه چیزی الزام قانونی دارد؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Who holds legal dominance and ultimate title over an object?"
      },
      "ru": {
        "question": "Кто обладает полным юридическим господством над вещью?"
      },
      "ar": {
        "question": "من يملك السيطرة القانونية التامة والملكية على الشيء؟"
      },
      "fa": {
        "question": "چه کسی تسلط و سلطه حقوقی کامل بر یک شیء دارد؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "What is the legal status of a security officer at entrance access control?"
      },
      "ru": {
        "question": "Каков правовой статус сотрудника безопасности на контроле доступа?"
      },
      "ar": {
        "question": "ما هي الصفة القانونية لحارس الأمن عند مراقبة الدخول؟"
      },
      "fa": {
        "question": "نگهبان حراست در کنترل ورود از نظر حقوقی چه سمتی دارد؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Which right permits the immediate recovery of stolen goods caught in the act?"
      },
      "ru": {
        "question": "Какое право разрешает немедленный возврат украденной вещи по горячим следам?"
      },
      "ar": {
        "question": "ما هو الحق الذي يسمح باستعادة المسروقات فوراً عند ضبط السارق متلبساً؟"
      },
      "fa": {
        "question": "کدام حق اجازه پس گرفتن فوری مال مسروقه را در لحظه ارتکاب جرم می‌دهد؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Against which attacks may self-defense be lawfully exercised?"
      },
      "ru": {
        "question": "Против каких нападений разрешена необходимая оборона?"
      },
      "ar": {
        "question": "ضد أي اعتداء يجوز ممارسة الدفاع الشرعي؟"
      },
      "fa": {
        "question": "در برابر چه نوع حملاتی دفاع مشروع مجاز است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Who is permitted to provisionally apprehend a person caught in the act under § 127 (1) StPO?"
      },
      "ru": {
        "question": "Кто имеет право временно задержать лицо на месте преступления по § 127 ч. 1 StPO?"
      },
      "ar": {
        "question": "من يحق له توقيف شخص مؤقتاً عند تلبسه بجريمة وفقاً للمادة 127 الفقرة 1 StPO؟"
      },
      "fa": {
        "question": "چه کسی مجاز است فرد را در لحظه ارتکاب جرم طبق بند ۱ ماده ۱۲۷ موقتاً بازداشت کند؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Which criminal offense is committed when a trespass ban is deliberately violated?"
      },
      "ru": {
        "question": "Какое правонарушение совершается при нарушении запрета на вход в помещение?"
      },
      "ar": {
        "question": "ما هي الجريمة المرتكبة عند انتهاك حظر الدخول الصادر بحق شخص ما؟"
      },
      "fa": {
        "question": "در صورت سرپیچی از دستور ممنوعیت ورود به ملک، چه جرمی محقق می‌شود؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "When may the use of firearms occur as lawful self-defense in security service?"
      },
      "ru": {
        "question": "Когда применение огнестрельного оружия в охране допускается как необходимая оборона?"
      },
      "ar": {
        "question": "متى يجوز استخدام السلاح الناري في خدمة الحراسة كدفاع شرعي؟"
      },
      "fa": {
        "question": "چه زمانی استفاده از سلاح گرم در حراست به عنوان دفاع مشروع مجاز است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Which weapons permit is required to carry pepper spray labeled for animal defense?"
      },
      "ru": {
        "question": "Какое разрешение требуется для ношения перцового баллончика для защиты от животных?"
      },
      "ar": {
        "question": "ما هو الترخيص المطلوب لحمل رذاذ الفلفل المخصص للدفاع ضد الحيوانات؟"
      },
      "fa": {
        "question": "برای حمل اسپری فلفل دارای برچسب دفاع در برابر حیوانات به چه مجوزی نیاز است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Which accident prevention regulation specifically governs guarding and security services?"
      },
      "ru": {
        "question": "Какое предписание по охране труда регулирует деятельность служб охраны?"
      },
      "ar": {
        "question": "ما هي لائحة الوقاية من الحوادث المنظمة لخدمات الحراسة والأمن؟"
      },
      "fa": {
        "question": "کدام آیین‌نامه پیشگیری از حوادث ناظر بر خدمات نگهبانی و حراست است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Which core principle always applies in security services when your own life is in danger?"
      },
      "ru": {
        "question": "Какое основное правило действует в охране при угрозе собственной жизни?"
      },
      "ar": {
        "question": "ما هو المبدأ الأساسي المطبق دائماً في الحراسة عند وجود خطر على الحياة؟"
      },
      "fa": {
        "question": "در هنگام به خطر افتادن جان در حین خدمت حراست، کدام اصل همواره حاکم است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "What belongs to the structural / passive security technology of a facility?"
      },
      "ru": {
        "question": "Что относится к пассивным техническим средствам безопасности объекта?"
      },
      "ar": {
        "question": "ما الذي ينتمي إلى تقنيات الأمان الهيكلية السلبية للمنشأة؟"
      },
      "fa": {
        "question": "کدام مورد جزو تجهیزات امنیتی غیرفعال و سازه‌ای یک ساختمان است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "Which fire class covers flammable liquid substances such as gasoline and oils?"
      },
      "ru": {
        "question": "Какой класс пожара охватывает горючие жидкие вещества, такие как бензин?"
      },
      "ar": {
        "question": "أي فئة من فئات الحرائق تشمل السوائل القابلة للاشتعال مثل البنزين؟"
      },
      "fa": {
        "question": "کدام رده آتش‌سوزی شامل مایعات قابل اشتعال مانند بنزین و روغن‌ها است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "How do you correctly de-escalate confrontations with aggressive individuals?"
      },
      "ru": {
        "question": "Как правильно вести себя для деэскалации агрессивно настроенных лиц?"
      },
      "ar": {
        "question": "كيف تتصرف بشكل صحيح لتهدئة المواقف وخفض التوتر مع الأشخاص العدوانيين؟"
      },
      "fa": {
        "question": "نحوه رفتار صحیح برای تنش‌زدایی در مواجهه با افراد پرخاشگر چگونه است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "What minimum safety distance should be maintained in potential conflict situations?"
      },
      "ru": {
        "question": "Какую минимальную дистанцию безопасности следует соблюдать в конфликте?"
      },
      "ar": {
        "question": "ما هي مسافة الأمان الدنيا التي يجب الحفاظ عليها في حالات النزاع؟"
      },
      "fa": {
        "question": "در شرایط درگیری و تنش، حداقل فاصله ایمنی که باید رعایت شود چقدر است؟"
      }
    },
    "options": [
      {
  ...
  },
  {
    ...
    "translations": {
      "en": {
        "question": "What term describes generalized prejudices and preconceived notions regarding people of different backgrounds?"
      },
      "ru": {
        "question": "Что описывает обобщенные предрассудки и предубеждения в отношении людей иного происхождения?"
      },
      "ar": {
        "question": "ما الذي يصف الأحكام المسبقة والتعميمات النمطية تجاه الأشخاص من خلفيات مختلفة؟"
      },
      "fa": {
        "question": "چه مفهومی پیش‌داوری‌ها و کلیشه‌های ذهنی تعمیم‌یافته نسبت به افراد را توصیف می‌کند؟"
      }
    },
    "options": [
      {
